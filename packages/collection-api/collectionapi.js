...
CollectionAPI._requestListener.prototype._authenticate = function() {
  ...
  if (collectionOptions && typeof collectionOptions.authToken === 'function' ) {
    return collectionOptions.authToken( self._requestAuthToken  );
  }

  // Check the global auth token
  if (typeof self._server.options.authToken === 'function' ) {
    return self._server.options.authToken( self._requestAuthToken );
  }
